...
if (o.distancia) card.appendChild(makeInfoRow("&#x1F4CD; Distancia", parseFloat(o.distancia).toFixed(1) + " km"));
  ...
  card.appendChild(cliRow);
    ...
    if (o.endereco_entrega) {
      ...
      if (o.tipo_pagamento === "maquina") {
        var vProd = parseFloat(o.valor_pedido || 0); var vEntrega = parseFloat(o.valor_total || 0); var vTotal = vProd + vEntrega;
  ...
  card.appendChild(pagDiv);
              if (tipoPag && tipoPag.indexOf('cartao') !== -1) {
                            var vCli = parseFloat(o.valor_pedido || 0) + parseFloat(o.valor_total || 0);
                                          if (vCli > 0) {
